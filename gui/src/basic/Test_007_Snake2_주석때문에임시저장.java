...
class SnakePanel extends JPanel implements KeyListener, Runnable, ActionListener{
	...
	private ArrayList <Integer[]> itemYX = new ArrayList <>();
	...
	private void printItemList() {
		for(int i = 0; i < this.itemYX.size(); i++) {
			int y = this.itemYX.get(i)[0];
			int x = this.itemYX.get(i)[0];
		...
		for (int i = 0; i < this.MAPSIZE; i++) {
			for (int j = 0; j < this.MAPSIZE; j++) {
				if (this.map[i][j] != null) {
					...
					g.fillRect(this.map[i][j].getX(), this.map[i][j].getY(), this.map[i][j].getW(),this.map[i][j].getH());
					g.setColor(Color.white);
					g.drawRect(this.map[i][j].getX(), this.map[i][j].getY(), this.map[i][j].getW(),this.map[i][j].getH());
				}
			}
		}
	}
...
//	}
//	
//	private boolean itemChkUp(int mHeadY, int mHeadX) {
...
//	}
//	
//	private boolean bodyChkUp(int mHeadY, int mHeadX) {
...
//	}
//	
//	private void wallMUp(ArrayList<SnakeRect> tempSnake) {
...
//	}
//	
//	private void itemMUp(int mHeadY, int mHeadX, ArrayList<SnakeRect> tempSnake) {
//		int itemIdx = -1;
//		for(int i = 0; i < this.itemYX.size(); i++) {
//			if(this.itemYX.get(i)[0] == mHeadY && this.itemYX.get(i)[1] == mHeadX) {
//				itemIdx = i;
...
//	}
//	
//	private void bodyMUp(ArrayList<SnakeRect> tempSnake) {
//		this.snake.removeAll(this.snake);
//		for(int i = 0; i < tempSnake.size() - 1; i++) {
//			if(i == 0) {
//				tempSnake.get(i).setC(snakeBC);
...
//	}
//	
//	private void notingMUp(ArrayList<SnakeRect> tempSnake) {
//		this.snake.removeAll(this.snake);
//		SnakeRect temp = tempSnake.get(0);
//		SnakeRect head = new SnakeRect(temp.getX(), temp.getY() - temp.getH(), 50, 50) ;
...
//	}
//	
//	private boolean itemChkLeft(int mHeadY, int mHeadX) {
//		boolean itemChk = false;
//		for(int i = 0; i < this.itemYX.size(); i++) {
//			if(this.itemYX.get(i)[0] == mHeadY && this.itemYX.get(i)[1] == mHeadX) {
//				itemChk = true;
...
//	}
//
//	private boolean bodyChkLeft(int mHeadY, int mHeadX) {
//		boolean bodyChk = false;
//		if(this.snake.size() >= 5) {
//			for(int i = 3; i < this.snake.size() - 1; i++) {
//				if(this.snake.get(i).getX() == mHeadX && this.snake.get(i).getY() == mHeadY) {
...
//	}
//
//	private void wallMLeft(ArrayList<SnakeRect> tempSnake) {
//		this.snake.removeAll(this.snake); // 머리 값은 색만 바뀌고 꼬리 삭제
//		for(int i = 0; i < tempSnake.size() - 1; i++) {
//			if(i == 0) {
//				tempSnake.get(i).setC(snakeBC);
//			}
...
//	}
//
//	private void itemMLeft(int mHeadY, int mHeadX, ArrayList<SnakeRect> tempSnake) {
//		int itemIdx = -1;
//		for(int i = 0; i < this.itemYX.size(); i++) {
//			if(this.itemYX.get(i)[0] == mHeadY && this.itemYX.get(i)[1] == mHeadX) {
//				itemIdx = i;
...
//	}
//	
//	private void bodyMLeft(ArrayList<SnakeRect> tempSnake) {
//		this.snake.removeAll(this.snake);
//		for(int i = 0; i < tempSnake.size() - 1; i++) {
//			if(i == 0) {
//				tempSnake.get(i).setC(snakeBC);
...
//	}
//	
//	private void notingMLeft(ArrayList<SnakeRect> tempSnake) {
//		this.snake.removeAll(this.snake);
//		SnakeRect temp = tempSnake.get(0);
//		SnakeRect head = new SnakeRect(temp.getX() - temp.getW(), temp.getY(), 50, 50) ;
//		head.setC(this.snakeHC);
//		this.snake.add(head);
//		for(int i = 0; i < tempSnake.size() - 1; i++) {
//			if(i == 0) {
...
//	}
//	
//	private boolean itemChkDown(int mHeadY, int mHeadX) {
//		boolean itemChk = false;
//		for(int i = 0; i < this.itemYX.size(); i++) {
//			if(this.itemYX.get(i)[0] == mHeadY && this.itemYX.get(i)[1] == mHeadX) {
//				itemChk = true;
...
//	}
//	
//	private boolean bodyChkDown(int mHeadY, int mHeadX) {
//		boolean bodyChk = false;
//		if(this.snake.size() >= 5) {
//			for(int i = 3; i < this.snake.size() - 1; i++) {
//				if(this.snake.get(i).getX() == mHeadX && this.snake.get(i).getY() == mHeadY) {
...
//	}
//	
//	private void wallMDown(ArrayList<SnakeRect> tempSnake) {
//		this.snake.removeAll(this.snake);
//		for(int i = 0; i < tempSnake.size() - 1; i++) {
//			if(i == 0) {
//				tempSnake.get(i).setC(snakeBC);
...
//	}
//	
//	private void itemMDown(int mHeadY, int mHeadX, ArrayList<SnakeRect> tempSnake) {
//		int itemIdx = -1;
//		for(int i = 0; i < this.itemYX.size(); i++) {
//			if(this.itemYX.get(i)[0] == mHeadY && this.itemYX.get(i)[1] == mHeadX) {
//				itemIdx = i;
...
//	}
//	
//	private void bodyMDown(ArrayList<SnakeRect> tempSnake) {
//		this.snake.removeAll(this.snake);
//		for(int i = 0; i < tempSnake.size() - 1; i++) {
//			if(i == 0) {
//				tempSnake.get(i).setC(snakeBC);
...
//	}
//	
//	private void notingMDown(ArrayList<SnakeRect> tempSnake) {
//		this.snake.removeAll(this.snake);
//		SnakeRect temp = tempSnake.get(0);
//		SnakeRect head = new SnakeRect(temp.getX(), temp.getY() + temp.getH(), 50, 50) ;
//		head.setC(this.snakeHC);
...
//	}
//	
//	private boolean itemChkRight(int mHeadY, int mHeadX) {
//		boolean itemChk = false;
//		for(int i = 0; i < this.itemYX.size(); i++) {
//			if(this.itemYX.get(i)[0] == mHeadY && this.itemYX.get(i)[1] == mHeadX) {
//				itemChk = true;
...
//	}
//
//	private boolean bodyChkRight(int mHeadY, int mHeadX) {
//		boolean bodyChk = false;
//		if(this.snake.size() >= 5) {
//			for(int i = 3; i < this.snake.size() - 1; i++) {
//				if(this.snake.get(i).getX() == mHeadX && this.snake.get(i).getY() == mHeadY) {
...
//	}
//
//	private void wallMRight(ArrayList<SnakeRect> tempSnake) {
//		this.snake.removeAll(this.snake); // 머리 값은 색만 바뀌고 꼬리 삭제
//		for(int i = 0; i < tempSnake.size() - 1; i++) {
//			if(i == 0) {
//				tempSnake.get(i).setC(snakeBC);
...
//	}
//
//	private void itemMRight(int mHeadY, int mHeadX, ArrayList<SnakeRect> tempSnake) {
//		int itemIdx = -1;
//		for(int i = 0; i < this.itemYX.size(); i++) {
//			if(this.itemYX.get(i)[0] == mHeadY && this.itemYX.get(i)[1] == mHeadX) {
//				itemIdx = i;
...
//	}
//	
//	private void bodyMRight(ArrayList<SnakeRect> tempSnake) {
//		this.snake.removeAll(this.snake);
//		for(int i = 0; i < tempSnake.size() - 1; i++) {
//			if(i == 0) {
//				tempSnake.get(i).setC(snakeBC);
...
//	}
//	
//	private void notingMRight(ArrayList<SnakeRect> tempSnake) {
//		this.snake.removeAll(this.snake);
//		SnakeRect temp = tempSnake.get(0);
//		SnakeRect head = new SnakeRect(temp.getX() + temp.getW(), temp.getY(), 50, 50) ;
//		head.setC(this.snakeHC);
...
//	}
	...
	public void run() {
		while(true) {
			if(this.snake.size() != 0 && !this.gameEnd) {
				autoMoving();
			}
		}
	}
...
public class Test_007_Snake2_주석때문에임시저장 {
